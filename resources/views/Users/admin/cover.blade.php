...
@endphp
  <head>
    ...
    <title>{{ config('app.name','jsr') }}</title>
            ...
            <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
              ...
              <div x-data="{ isActive: false, open: false}">
                ...
                <a
                  ...
                  class="flex items-center p-2 text-gray-500 transition-colors rounded-md dark:text-light hover:bg-primary-100 dark:hover:bg-primary {{ in_array(Request::segment(2), ['viewUser', 'addUser']) ? 'bg-primary-100 dark:bg-primary' : '' }}"
                  role="button"
                  aria-haspopup="true"
                  :aria-expanded="(open || isActive) ? 'true' : 'false'"
                >
              ...
              <div x-data="{ isActive: false, open: false}">
                ...
                <a
                  href="#"
                  @click="$event.preventDefault(); open = !open"
                  class="flex items-center p-2 text-gray-500 transition-colors rounded-md dark:text-light hover:bg-primary-100 dark:hover:bg-primary {{ in_array(Request::segment(2), ['viewDarsat', 'darsat']) ? 'bg-primary-100 dark:bg-primary' : '' }}"
                  role="button"
                  aria-haspopup="true"
                  :aria-expanded="(open || isActive) ? 'true' : 'false'"
                >
              ...
              <div x-data="{ isActive: false, open: false}">
                <a
                  href="#"
                  @click="$event.preventDefault(); open = !open"
                  class="flex items-center p-2 text-gray-500 transition-colors rounded-md dark:text-light hover:bg-primary-100 dark:hover:bg-primary {{ in_array(Request::segment(2), ['Ibitabo', 'books']) ? 'bg-primary-100 dark:bg-primary' : '' }}"
                  role="button"
                  aria-haspopup="true"
                  :aria-expanded="(open || isActive) ? 'true' : 'false'"
                >
                  ...
                  <span class="ml-2 text-sm">Books</span>
                  <span aria-hidden="true" class="ml-auto">
                    <!-- active class 'rotate-180' -->
                    <svg
                      class="w-4 h-4 transition-transform transform"
              ...
              <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                ...
                <div class="relative" x-data="{ open: false }">
                  ...
                  >
                    ...
                    <img class="w-10 h-10 rounded-full" src="{{ URL::to('/') }}/auth/build/images/avatar.jpg" alt="Ahmed Kamel" />
                  </button>
                    ...
                    <div class="relative flex-shrink-0">
                      <span class="relative z-10 inline-block overflow-visible rounded-ful">
                        <img
                          ...
                          src="{{ URL::to('/') }}/auth/build/images/avatar.jpg"
                          alt="Ahmed kamel"
                        />
                      </span>
                      <div class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker"></div>
                  ...
                  <div class="flex px-4 space-x-4">
                    <div class="relative flex-shrink-0">
                      <span class="relative z-10 inline-block overflow-visible rounded-ful">
                        <img
                          class="object-cover rounded-full w-9 h-9"
                          src="{{ URL::to('/') }}/auth/build/images/avatar-1.jpg"
                          alt="Ahmed kamel"
                        />
                      </span>
                      <div class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker"></div>
          ...
          <div class="flex flex-col h-screen">
            ...
            <!-- <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
              ...
              <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                  <img class="w-10 h-10 rounded-lg" src="{{ URL::to('/') }}/auth/build/images/cover.jpg" alt="Post cover" />
                </div>
              ...
              <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                  <img class="w-10 h-10 rounded-lg" src="{{ URL::to('/') }}/auth/build/images/avatar.jpg" alt="Ahmed Kamel" />
                </div>
                <div class="flex-1 max-w-xs overflow-hidden">
              ...
              <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                  <img class="w-10 h-10 rounded-lg" src="{{ URL::to('/') }}/auth/build/images/cover-2.jpg" alt="K-WD Dashboard" />
                </div>
                <div class="flex-1 max-w-xs overflow-hidden">
