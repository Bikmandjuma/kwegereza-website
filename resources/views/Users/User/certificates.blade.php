...
<div class="p-4 md:p-6">
    ...
    <h1 class="mb-6 text-2xl font-bold" style="color:#094939">{{ __('certificates.title') }}</h1>
    ...
    @else
        <div class="grid gap-5 md:grid-cols-2">
            ...
            <div class="p-5 bg-white shadow-lg rounded-3xl">
                ...
                <h2 class="mb-2 font-bold" style="color:#094939">{{ $cert->course->title ?? $cert->title }}</h2>
                ...
                <a href="{{ route('student.certificates.show', $cert->id) }}" target="_blank"
                   class="inline-block px-4 py-2 text-sm font-semibold text-white rounded-xl" style="background:#058e48">
