...
<div style="min-height:60vh;display:flex;align-items:center;justify-content:center;padding:40px 16px;">
  <div style="max-width:380px;width:100%;background:#FDFAF3;border-radius:24px;padding:34px;box-shadow:0 16px 34px rgba(9,73,57,.25);text-align:center;">

    <i class="fa-solid fa-shield-halved" style="font-size:36px;color:#0B6D20;margin-bottom:14px;"></i>
    <h1 style="color:#0B3D2E;font-weight:800;font-size:18px;margin-bottom:6px;">{{ __('twofa.challenge_title') }}</h1>
    ...
    <form action="{{ route('student.2fa.challenge.submit') }}" method="POST">
      ...
      <button type="submit" style="width:100%;padding:13px;background:#0B6D20;color:#fff;border:none;border-radius:14px;font-weight:700;cursor:pointer;">
        {{ __('twofa.confirm') }}
      </button>
    </form>
