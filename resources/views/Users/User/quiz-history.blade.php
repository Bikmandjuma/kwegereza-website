...
<div class="p-4 md:p-6">
    ...
    <h1 class="mb-6 text-2xl font-bold" style="color:#0B3D2E">Ibizamini Byanjye</h1>

    <h2 class="mb-3 text-lg font-bold" style="color:#0B3D2E">Ibitegereje (Available / Undone)</h2>
    @if($undone->isEmpty())
    ...
    @else
        <div class="grid gap-4 mb-8 md:grid-cols-2">
            ...
            <div class="p-5 bg-white shadow-lg rounded-2xl">
                <p class="mb-1 font-bold" style="color:#0B3D2E">{{ $quiz->title }}</p>
    ...
    <h2 class="mb-3 text-lg font-bold" style="color:#0B3D2E">Amateka (Byarangiye)</h2>
    <div class="overflow-hidden bg-white shadow-lg rounded-3xl">
        <table class="w-full text-sm text-left">
            ...
            <tbody class="divide-y">
                ...
                <tr>
                    <td class="px-5 py-3 font-semibold" style="color:#0B3D2E">{{ $attempt->quiz->title }}</td>
                    ...
                    <td class="px-5 py-3">
                        <a href="{{ route('student.quizzes.result', $attempt->id) }}" class="font-semibold" style="color:#0B6D20">Reba →</a>
                    </td>
                </tr>
                @empty
